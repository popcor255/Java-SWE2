...
class MSGApplication {
  ...
  //
  {
    ...
    try {
      if (newAnnualOperatingExpenses >= 0.0) {
        ...
        FileOutputStream newFileOutput = new FileOutputStream(operatingExpensesFile); // output stream for
                                                                                      // newPrintStream
  ...
  //
  // updateAnnualOperatingExpenses obtains the new annual operating expenses from
  // user, validates,
  ...
  //
  // initializeApplication initializes annual operating expenses from file
  // opexp.dat, if it exists.
