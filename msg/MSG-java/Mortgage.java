...
class Mortgage extends Asset {
  ...
  static final float MAXIMUM_PERC_OF_INCOME = (float) 0.10;
  ...
  // the expected total weekly mortgage amount less the expected total weekly
  // grants.
  //
  {
    try {
  ...
  //
  // performDeletion performs the actual deletion of a mortgage record from a
  // file.
  //
  {
    try {
